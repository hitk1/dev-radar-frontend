...
function DevForm({ onSubmit }) {
    ...
    async function handleSubmit(e) {
        ...
        await onSubmit({ github_username, techs: techs.split(','), latitude, longitude })
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            <div className="input-block">
                ...
                <input name="github_username" id="github_username" required value={github_username} onChange={event => setGithubUsername(event.target.value)} />
            </div>
